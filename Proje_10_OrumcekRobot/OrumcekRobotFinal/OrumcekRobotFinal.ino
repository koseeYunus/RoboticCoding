...
// Define 8 Servos
Servo myServo1; // On Sol Ust Servo
Servo myServo2; // On Sol Alt Servo
Servo myServo3; // Arka Sol Ust Servo
Servo myServo4; // Arka Sol Alt Servo
Servo myServo5; // Arka Sag Ust Servo
Servo myServo6; // Arka Sag Alt Servo
Servo myServo7; // On Sag Ust Servo
Servo myServo8; // On Sag Alt Servo
